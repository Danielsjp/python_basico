...
class Coche():
    ...
    def __str__(self):
        #return 
        return f"el coche es de la marca {self.marca} y del color {self.color}"
    def mostrar_caracteristicas(self):
        return f"{self.marca} - {self.color} - {self.combustible} - {self.cilindrada}"
    
coche = Coche("Opel", "Rojo", "Diesel", "9000")
